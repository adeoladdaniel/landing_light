The frontend folder structure is bootstraped from a personal folder structure created by me. This structure is built on vue create  and use the DDD (Design driven domain) folder approach pattern.
